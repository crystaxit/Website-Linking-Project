...
String str="delete * from student where"+" "+p1+" "+p2+"'"+p3+"'"+";";
//String sql="select * from student where Rollno='3'";
//out.println(str);
try{
        String pre="select * from student where"+" "+p1+"="+"'"+p3+"'";
        //out.println(pre);
	...
	out.println("<table align=center border=1><h1 align='center'>BEFORE DELETING RECORD"); 
	...
	int a=pst.executeUpdate();    
        String pre2="select * from student";
               
         PreparedStatement pst2= con.prepareStatement(pre2);
         ResultSet rs2=pst2.executeQuery();
                out.println("<br><table align=center border=1><h1 align='center'>AFTER DELETING RECORD");
                out.println("<br><br>");
	out.println("<tr><th>Name</th><th>RollNO</th><th> Java</th><th>SEN</th><th>CTE</th></th><th>ISE</th><th>NMA</th>");
        while(rs2.next())
	 {
